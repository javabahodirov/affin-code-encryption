function output_encrypt() {
    ...
    if (a % 2 != 0 && a != 13 && isCapLetter) {
        ...
        resTable = resTable + "<tr><td>Original Text</td>";
        for (i = 0; i < arr.length; i++) {
        ...
        //4th row
        resTable = resTable + "<tr><td>(" + a + "x+" + b + ") mod 26</td>";
        for (i = 0; i < arr.length; i++) {
            let modOfCode = (a * (arr[i].charCodeAt(0) - 65) + parseInt(b)) % parseInt(26);
            resTable = resTable + "<td>" + (modOfCode) + "</td>";
        }
        resTable = resTable + "</tr>";
        ...
        for (i = 0; i < arr.length; i++) {
            let modOfCode = (a * (arr[i].charCodeAt(0) - 65) + parseInt(b)) % parseInt(26);
            resTable = resTable + "<td>" + String.fromCharCode(modOfCode + 65) + "</td>";
        }
        resTable = resTable + "</tr>";
